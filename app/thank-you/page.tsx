  ...
  return (
    <main style={{ minHeight: "100vh", background: "var(--bg)" }}>
      ...
      <section style={{ padding: "24px 0 56px" }}>
        <div className="am-wrap" style={{ maxWidth: 680 }}>
          <div style={{ textAlign: "center", marginBottom: 10 }}>
            <p className="am-bounce" style={{ fontFamily: "var(--script)", fontSize: 30, color: "var(--accent)", margin: 0 }}>Watch this!</p>
          </div>
      ...
      <section style={{ padding: "56px 0", borderTop: "1px solid var(--rule)", background: "var(--paper)" }}>
        <div className="am-wrap">
          <p className="am-eyebrow" style={{ marginBottom: 12 }}>Before your call</p>
      ...
      <section style={{ padding: "64px 0" }}>
        <div className="am-wrap">
          <p className="am-eyebrow" style={{ color: "var(--accent)", marginBottom: 12 }}>✓ Your call is booked</p>
      ...
      <section style={{ padding: "64px 0", borderTop: "1px solid var(--rule)", background: "var(--paper)" }}>
        <div className="am-wrap">
          <p className="am-eyebrow" style={{ marginBottom: 12 }}>Watch in order · 20 minutes total</p>
      ...
      <section style={{ padding: "64px 0" }}>
        <div className="am-wrap">
          <p className="am-eyebrow" style={{ marginBottom: 12 }}>Real clients, real physiques</p>
      ...
      <section style={{ padding: "64px 0 80px", borderTop: "1px solid var(--rule)", background: "var(--soft)" }}>
        <div className="am-wrap" style={{ textAlign: "center", maxWidth: 720 }}>
          <p className="am-eyebrow" style={{ marginBottom: 12 }}>Quick background</p>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: 16 }}>
            {[{ num: "100%", label: "Natural Approach" }, { num: "300+", label: "Workout Library" }, { num: "1:1", label: "Coaching With Jaden" }].map((s) => (
              <div key={s.label} style={{ borderTop: "1px solid var(--ink)", borderBottom: "1px solid var(--rule)", background: "var(--bg)", padding: "22px 14px" }}>
                ...
                <p className="am-eyebrow" style={{ fontSize: 9 }}>{s.label}</p>
              </div>
            ))}
          </div>
        </div>
